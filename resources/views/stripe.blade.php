                            ...
                            <form role="form" action="{{ route('stripe.post') }}" method="post"
                                ...
                                <div class='form-row row'>
                                    <div class='col-xs-12 form-group required'>
                                        ...
                                        <input class='form-control' size='4' type='text' name="order_id"
                                ...
                                <div class='form-row row'>
                                    <div class='col-xs-12 form-group required'>
                                        ...
                                        <input class='form-control' size='4' type='text' name="client_name"
                                ...
                                <div class="form-row row">
                                    <div class="col-xs-12">
                                        <button class="sbtn btn-block" type="submit">Pay Now
